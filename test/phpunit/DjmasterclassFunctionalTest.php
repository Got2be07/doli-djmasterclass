...
/**
 * \file    test/phpunit/DjmasterclassFunctionalTest.php
...
/**
 * Class DjmasterclassFunctionalTest
 *
 ...
 *
 * @package Testdjmasterclass
 */
class DjmasterclassFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDjmasterclass')->click();
		} else {
			// Disable the module
			$this->byHref('modDjmasterclass')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/djmasterclass/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('djmasterclass/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/djmasterclass/admin/about.php');
		$this->authenticate();
		return $this->assertContains('djmasterclass/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('djmasterclasswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDjmasterclass_DjmasterclassTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDjmasterclass_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
