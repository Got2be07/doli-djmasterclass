...
/**
 *	\file       djmasterclass/djmasterclassindex.php
 *	\ingroup    djmasterclass
 *	\brief      Home page of djmasterclass top menu
 */
...
$langs->loadLangs(array("djmasterclass@djmasterclass"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->djmasterclass->myobject->read) accessforbidden();
...
// Draft MyObject
if (! empty($conf->djmasterclass->enabled) && $user->rights->djmasterclass->read)
{
	$langs->load("orders");
